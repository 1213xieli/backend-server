...
public class MethodName {
    ...
    public static final String METHOD_NAME_SAVE_YZRHDEATH = "saveYzRhDeath";//饲喂记录保存
    public static final String METHOD_NAME_QUERY_YZRHDEATH = "queryYzRhDeath";//饲喂记录查看序时簿
    public static final String METHOD_NAME_VIEW_YZRHDEATH = "viewYzRhDeath";//饲喂记录查看
    public static final String METHOD_NAME_DELETE_YZRHDEATH = "deleteYzRhDeath";//饲喂记录删除
    ...
    public static final String METHOD_NAME_QUERY_BATCH = "queryBatch";//用户批次
    public static final String METHOD_NAME_QUERY_DRIVER = "queryDriver";//拉料司机
    public static final String METHOD_NAME_QUERY_ENTRUST = "queryEntrust";//委托人

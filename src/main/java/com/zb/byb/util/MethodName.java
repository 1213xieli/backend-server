...
public class MethodName {
    ...
    public static final String USERBACKCLEAN_SAVE = "userBackClean_save"; // 洗消保存
    public static final String USERBACKCLEAN_VIEW = "userBackClean_view"; // 洗消单据查询
    public static final String QUERYCLEARSTEP = "queryClearStep"; // 洗消步骤
    public static final String USERBACKCLEAN_QUERY = "userBackClean_query"; // 洗消列表

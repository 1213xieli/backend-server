...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements EASLoginProxyService {
    ...
    // Use to get a proxy class for com.zb.byb.webService.EASLogin
    ...
    private java.lang.String EASLoginWSDDServiceName = "com/zb/byb/webService/EASLogin";
    ...
    public java.rmi.Remote getPort(javax.xml.namespace.QName portName, Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        ...
        if ("com/zb/byb/webService/EASLogin".equals(inputPortName)) {
            return getEASLogin();
        } else {
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://192.168.91.35:56898/ormrpc/services/EASLogin", "com/zb/byb/webService/EASLogin"));
        }
    ...
    public void setEndpointAddress(java.lang.String portName, java.lang.String address) throws javax.xml.rpc.ServiceException {
        ...
        if ("com/zb/byb/webService/EASLogin".equals(portName)) {
